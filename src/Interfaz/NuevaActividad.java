		...
		btnEnviar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(!textField.getText().equals("") && !textField_1.getText().equals("") && !textField_2.getText().equals("") && 
					...
					NuevaActividadControlador.guardarActividad(nombre, descripcion, horas, turno, fecha, false, false, false, 
															   false, proyecto, id_ong, profesor, asignatura, categoria, subcategoria, lugar);
